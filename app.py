...
# ==========================================
# حل مشكلة UnicodeEncodeError و lost sys.stdin نهائياً
...
COLOR_SIDEBAR = "#1E293B"       # رمادي أزرق داكن
COLOR_CARD = "#334155"          # بطاقات وواجهات الإدخال
COLOR_ACCENT = "#38BDF8"        # أزرق نيون للتمييز
COLOR_SUCCESS = "#4ADE80"       # أخضر للنجاح
COLOR_WARNING = "#FBBF24"       # أصفر للتنبيهات
COLOR_DANGER = "#F87171"        # أحمر للحذف
COLOR_TEXT_LIGHT = "#F8FAFC"    # نص أبيض
...
class IbnEzzApp(tk.Tk):
    ...
    def build_ui(self):
        ...
        status_txt = tk.Label(status_bar, text="الحالة: متصل بقاعدة البيانات | Single EXE Build Ready", font=("Segoe UI", 9), bg=COLOR_SIDEBAR, fg=COLOR_SUCCESS)
        status_txt.pack(side=tk.RIGHT, padx=15, pady=2)

    def start_clock(self):
        # صيغة وقت آمنة تماماً بدون رموز إيموجي لتجنب أخطاء الترميز
